    ...
    var body: some View {
        ZStack {
            ...
            Circle()
                ...
                .stroke(
                    LinearGradient(gradient: Gradient(colors: [Color.red]), startPoint: .topTrailing, endPoint: .bottomLeading),
...
struct XmarkAnimation_Previews: PreviewProvider {
